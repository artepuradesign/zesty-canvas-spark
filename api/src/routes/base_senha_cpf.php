<?php
// src/routes/base_senha_cpf.php - Rotas para administração de base_senha_cpf

require_once __DIR__ . '/../controllers/BaseSenhaCpfController.php';

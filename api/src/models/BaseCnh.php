<?php
// src/models/BaseCnh.php

class BaseCnh {
    private $db;
    private $table = 'base_cnh';
    ...
    public function create($data) {
        $fields = [
            'cpf_id', 'n_espelho', 'nome', 'foto_cnh', 'doc_identidade', 'orgao_expedidor',
            'uf_emissao', 'data_nascimento', 'pai', 'mae', 'permissao', 'acc', 'cat_hab',
            'n_registro', 'validade', 'primeira_habilitacao', 'observacoes', 'assinatura',
            'local', 'data_emissao', 'diretor', 'n_seg1', 'n_renach', 'qrcode'
        ];
    ...
    public function update($id, $data) {
        $fields = [
            'n_espelho', 'nome', 'foto_cnh', 'doc_identidade', 'orgao_expedidor',
            'uf_emissao', 'data_nascimento', 'pai', 'mae', 'permissao', 'acc', 'cat_hab',
            'n_registro', 'validade', 'primeira_habilitacao', 'observacoes', 'assinatura',
            'local', 'data_emissao', 'diretor', 'n_seg1', 'n_renach', 'qrcode'
        ];

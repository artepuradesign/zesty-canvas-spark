...
require_once __DIR__ . '/../src/controllers/BaseOperadoraTimController.php';
...
try {
    // Reaproveita conexão padrão (mesmo padrão da OI)
    $db = getConnection();
    ...
    $basePaths = ['/api/base-operadora-tim', '/base-operadora-tim'];
    ...
    error_log("ROUTE_BASE_OPERADORA_TIM: Erro fatal - " . $e->getMessage());

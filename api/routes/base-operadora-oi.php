...
require_once __DIR__ . '/../src/controllers/BaseOperadoraOiController.php';
...
try {
    ...
    $controller = new BaseOperadoraOiController($db);
    $method = $_SERVER['REQUEST_METHOD'];
    $path = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);

    // Remover prefixo da API se presente
    $basePaths = ['/api/base-operadora-oi', '/base-operadora-oi'];
    ...
    error_log("ROUTE_BASE_OPERADORA_OI: Erro fatal - " . $e->getMessage());

  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-pink-50 to-indigo-100 dark:from-purple-900 dark:via-pink-900 dark:to-indigo-900"></div>
        
        {/* Gradiente adicional para profundidade */}
        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-purple-100/20 to-pink-100/10 dark:from-transparent dark:via-purple-900/20 dark:to-pink-900/10"></div>

...
const MODULE_BACK_ROUTE = '/dashboard/qrcode-rg-1m';
...
const QRCodeRg1mTodos = () => {
  ...
  const handleSaveQrAsSvg = () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `qrcode-${qrModalData ? qrModalData.substring(0, 20) : 'rg1m'}.svg`;
...
export default QRCodeRg1mTodos;

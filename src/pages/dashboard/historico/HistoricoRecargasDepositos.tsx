...
import { ArrowLeft, RefreshCw, RefreshCcw } from 'lucide-react';
...
import { formatBrazilianCurrency, formatDate, filterTransactions, getRechargeTransactions } from '@/utils/historicoUtils';
        ...
        <CardHeader className="p-3 sm:p-6">
          <div className="flex items-center justify-between gap-2">
            <CardTitle className="flex items-center gap-2 text-base sm:text-lg">
              <RefreshCcw className="h-4 w-4 sm:h-5 sm:w-5 text-primary" />
              <span className="truncate">Histórico · Recargas e Depósitos</span>
            </CardTitle>
